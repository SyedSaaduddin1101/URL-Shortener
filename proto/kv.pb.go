...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\fURLShortener\x122\n" +
	"\aShorten\x12\x12.kv.ShortenRequest\x1a\x13.kv.ShortenResponse\x122\n" +
	"\aResolve\x12\x12.kv.ResolveRequest\x1a\x13.kv.ResolveResponseB!Z\x1fdistributed-url-shortener/protob\x06proto3"
...
var file_proto_kv_proto_goTypes = []any{
	(*ShortenRequest)(nil),  // 0: kv.ShortenRequest
	(*ShortenResponse)(nil), // 1: kv.ShortenResponse
	(*ResolveRequest)(nil),  // 2: kv.ResolveRequest
	(*ResolveResponse)(nil), // 3: kv.ResolveResponse
}
var file_proto_kv_proto_depIdxs = []int32{
	0, // 0: kv.URLShortener.Shorten:input_type -> kv.ShortenRequest
	2, // 1: kv.URLShortener.Resolve:input_type -> kv.ResolveRequest
	1, // 2: kv.URLShortener.Shorten:output_type -> kv.ShortenResponse
	3, // 3: kv.URLShortener.Resolve:output_type -> kv.ResolveResponse
